...
syn0 = np.random.random((3, 4))  # 3x4 matrix of weights ((2 inputs + 1 bias) x 4 nodes in the hidden layer)
syn1 = np.random.random((4, 1))  # 4x1 matrix of weights. (4 nodes x 1 output) - no bias term in the hidden layer.
